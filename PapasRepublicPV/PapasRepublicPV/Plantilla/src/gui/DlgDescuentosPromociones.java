...
public class DlgDescuentosPromociones extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			DlgDescuentosPromociones dialog = new DlgDescuentosPromociones();
	 ...
	 * Create the dialog.
	 */
	public DlgDescuentosPromociones() {
